...
function getAverage(value1, value2) {
  ...
  return res > Number.MAX_VALUE ? Number.MAX_VALUE - 1 : res;
}
 ...
 * The input parameter will always be greater than or equal to zero and will not be in decimal notation.
 *
 * @param {number} value
 * @return {number}
 *
...
function isPowerOfTwo(num) {
  return (
    parseInt(Math.log(num) / Math.log(2), 10) === Math.log(num) / Math.log(2)
  );
  // best solution:
